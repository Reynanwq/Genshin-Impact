...
public class CrudCharactersService {
    ...
    public void insertData(){
        ...
        Characters albedo = new Characters(1, "Albedo", "Cavaleiros de Favonius", 1-90, "Um gênio conhecido como Príncipe do Giz, ele é o Chefe Alquimista e Capitão da Equipe de Investigação dos Cavaleiros de Favonius.", "12/2020", "Masculino", "Ataque Normal: Técnica da Espada de Favonius - Branco | Abiogênese - Radiação Solar | Ritual da Progenitura - Maré Tectônica", "Pressão Calcária: Fase de Ascensão 1 | Sabedoria em Uma Garrafa: Fase de Ascensão 4 | Gênio Despertado: Passive", "Flor de Éden | Éon da Vida | Esplendor Solar | Queda Divina | Maré de Hadeano | Peoira da Purificação");
        Characters Alhaitham = new Characters(2, "Alhaitham", "Academia de Sumeru", 1-90, "O Atual escriba da academia Sumero,  um homem de grande inteligencia e talento. Vive sua vida livre e despreocupado, sendo uma pessoa muito difícil de se encontrar", "01/2023", "Masculino", "Ataque Normal: Metodo investigativo reverso | Entendimento Mútuo: Representação do Conhecimento | Alienação: REstrição de Ilustraçaõ", "Quatro Principios de Retificaão | Revelação da FLoresta dos Enigmaas | Lei da redução de Superdeterminada", "Observaão Direta | Debate | Anotações Escondidas | Aplicação da Justiça | O Grau de Sabedoria | Raciocinio Correto");
        Characters Aloy = new Characters(3, "Aloy", "Cavaleiro Errante", 1-90, "Era uma pária, agora uma caçadora de uma avidez inigualável. Pronta para fazer a coisa certa com seu arco, a qualquer momento.", "10/2021", "Feminino", "Ataque Normal: Disparos Rápidos | Natureza Gélida | Profecias do Alvorecer", "Percepção de Combate | Ataque Poderoso | Devagarinho", "Estrela de Outro Mundo: Nv.1 -> | Estrela de Outro Mundo: Nv.2 -> | Estrela de Outro Mundo: Nv.3 -> | Estrela de Outro Mundo: Nv.4 -> | Estrela de Outro Mundo: Nv.5 -> | Estrela de Outro Mundo: Nv.6 ->  ");
        Characters Amber = new Characters(4, "Amber", "Cavaleiros de Favonius", 1-90, "Sempre energética e cheia de vida, a Amber é a melhor, mas também a última Aventureira dos Cavaleiros de Favonius.", "09/2020", "Feminino", "Ataque Normal: Pontaria | Marionete Explosiva | Chuva Ardente", "Ninguém consegue fugir do meu campo de visão! | Disparo Preciso | Campeã Voadora", "Uma Flecha para Todos Governar | Coelho Ativado | Isso, Queima! | Não É Uma Boneca Qualquer... | É o Barão Coelho | Fogo Vivo");
        Characters Arataki_Itto = new Characters(5, "Arataki Itto", "Gangue Arataki", 1-90, "O primeiro e maior chefe da Gangue Arataki, famosa em Hanamizaka, na cidade de Inazuma... Espere, o quê? Nunca ouviu falar deles? Sério?", "12/2022", "Masculino", "Ataque Normal: Lenda do Combate | Masatsu Zetsugi: Explosão Akaushi! | Descendência Real: Contemplem, Itto o Maligno!", "Arataki Ichiban | Linhagem do Oni Carmesim | Itto o Lenhador", "Fique um Tempo e Escute | Juntem-se, Hora da Briga! | Lá Vem o Touro! | Cárcere Privado | 10 Anos de Fama de Hanamizaka | Arataki Itto, Presente!");
        Characters Baizhu = new Characters(6, "Beizhu", "Chalé de Bubu", 1-90, "O dono do Chalé de Bubu, sempre com uma cobra branca chamada Changsheng pendurada no pescoço. Um grande conhecedor de medicina, suas verdadeiras intenções são um grande mistério.", "04/2023", "Ataque Normal: Acupuntura Dourada | Diagnóstico Universal | Cura Holística", "Ataque Normal: Acupuntura Dourada | Diagnóstico Universal | Cura Holística", "Cinco Fortunas Eternas | Mãe Terra | Nutrição Herbal", "Observação Atenta | Discernimento Incisivo | Estabilidade Total | Percepção Ancestral | Sinais Ocultos da Mudança | Eliminação de Qi Malicioso");
        Characters Barbara = new Characters(7, "Barbara", "Igreja Favonius", 1-90, "Todos os habitantes de Mondstadt adoram a Barbara. Contudo, ela viu a palavra ídolo pela primeira vez em uma revista.", "09/2020", "Feminino", "Ataque Normal: Suspiro da Água | Que Comece o Espetáculo | Milagre Brilhante", "Temporada Gloriosa | Encora | Com todo o meu coração", "Balada Alegre | Explosão de Vitalidade | Estrela de Amanhã | A Atenção é o meu podeer | Vinculo de Inocencia | Dedicando tudo para você");
        ...
        Characters Candance = new Characters(10, "Candance", "", 1-90, "", "09/2022", "", "", "", "");
        Characters Collei = new Characters(11, "Collei", "", 1-90, "", "08/2022", "", "", "", "");
        Characters Cyno = new Characters(12, "Cyno", "", 1-90, "", "03/2023", "", "", "", "");
        Characters Dehya = new Characters(13, "Dehya", "", 1-90, "", "03/2023", "", "", "", "");
        Characters Diluc = new Characters(14, "Diluc", "", 1-90, "", "09/2020", "Masculino", "", "", "");
        Characters Diona = new Characters(15, "Diona", "", 1-90, "", "11//2020", "Feminino", "", "", "");
        Characters Dori = new Characters(16, "Dori", "", 1-90, "", "09/2022", "Feminino", "", "", "");
        Characters Eula = new Characters(17, "Eula", "", 1-90, "", "05/2021", "Feminino", "", "", "");
        Characters Faruzan = new Characters(18, "Faruzan", "", 1-90, "", "07/2022", "Feminino", "", "", "");
        Characters Dischi = new Characters(19, "Dischi", "", 1-90, "", "", "", "", "", "");
        ...
        Characters Kaedehara_Kazuha = new Characters(24, "Kaedehara_Kazuha", "", 1-90, "", "", "", "", "", "");
        Characters Kaeya = new Characters(25, "Kaeya", "", 0, "", "09/2020", "Masculino", "", "", "");
        Characters Kamisato_Ayaka = new Characters(26, "Kamisato_Ayaka", "", 1-90, "", "", "", "", "", "");
        Characters Kamisato_Ayato = new Characters(27, "Kamisato_Ayato", "", 1-90, "", "", "", "", "", "");
        ...
        Characters Kujou_Sara = new Characters(32, "Kujou_Sara", "", 1-90, "", "", "", "", "", "");
        Characters Kuki_Shinobu = new Characters(33, "Kuki_Shinobu", "", 1-90, "", "", "", "", "", "");
        Characters Laya = new Characters(34, "Laya", "", 1-90, "", "", "", "", "", "");
        ...
        Characters Noelle = new Characters(41, "Noelle", "", 1-90, "", "", "", "", "", "");
        Characters Qiqi = new Characters(42, "Qiqi", "", 1-90, "", "09/2020", "Feminino", "", "", "");
        Characters Shogun_Raiden = new Characters(43, "Shogun_Raiden", "", 1-90, "", "", "", "", "", "");
        ...
        Characters Sangonomiya_Kokomi = new Characters(46, "Sangonomiya_Kokomi", "", 1-90, "", "", "", "", "", "");
        ...
        Characters Shikanoin_Heizou = new Characters(49, "Shikanoin_Heizou", "", 1-90, "", "", "", "", "", "");
        ...
        Characters Tighnari = new Characters(53, "Tighnari", "", 1-90, "", "", "", "", "", "");
