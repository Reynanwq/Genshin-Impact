...
public class CrudCharactersService {
    ...
    public void insertData(){
        ...
        Characters Bennett = new Characters(9, "Bennett", "Guilda de Aventureiros", 90, "Um aventureiro de Mondstadt justo e bondoso, mas muito azarado.", "03/2022", "Masculino", "Ataque Normal: Espada da Sorte | Sobrecarga de Paixão | Viagem Fantástica", "Ressurgimento da Paixão | Fervor Intrépido | Deve Ser Seguro...", "Grande Expectativa | Escape da Desolação | Paixão Ardente | Odisseia Inesperada | O Verdadeiro Explorador | Fogo e Coragem");
        ...
        Characters Collei = new Characters(11, "Collei", "Vila Gandharva", 90, "Uma Guarda-Florestal em Treinamento que patrulha a Floresta Avidya. Por trás de seu entusiasmo, encontra-se uma personalidade bastante introvertida.", "08/2022", "Feminino", "Ataque Normal: Homenagem ao Tiro com Arco | Carícia das Flores | Segredo Miauvilhoso", "Retorno Floral | Quietude da Floresta | Campeã Voadora de Sumeru", "Patrulha Florestal | Pelas Colinas e Bosques | Fragrância de Verão");
/*
